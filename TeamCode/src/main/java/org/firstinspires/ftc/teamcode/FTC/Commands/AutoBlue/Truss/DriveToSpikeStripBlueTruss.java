...
@Config
public class DriveToSpikeStripBlueTruss extends CommandBase {
    ...
    public static double rightYOffset = -60;
    ...
    public DriveToSpikeStripBlueTruss(TeamPropPosition pos, Command pixelPlaceCommand) {
        this.pos = pos;
