...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.8987; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -7.9; // in; offset of the lateral wheel
    public static double Y_MULT = 1.00197;
    public static double X_MULT = 1.00551;
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "back"));
