...
public class NumberTracer extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory tr = new Trajectory(new Pose2d(300, 0), new Pose2d(900, 1750), new Pose2d(670, 1580), new Pose2d(160, 2900), new Pose2d(6330, -4220), new Pose2d(4600, -3400));


        trajectoryRunners.add(new TrajectoryRunner(hardwareMap, l, tr, 0, TrajectoryRunner.HeadingType.ConstantHeadingVelo, telemetry));
        tr = new Trajectory(new Pose2d(900, 1750), new Pose2d(2700, 2400), new Pose2d(1490, 950), new Pose2d(950, 1350), new Pose2d(-160, 270), new Pose2d(0, 0));
