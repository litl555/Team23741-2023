package org.firstinspires.ftc.teamcode.FTC.Commands.AutoBlue.Truss;
...
@Config
public class DriveToBackBoardBlueTruss extends CommandBase {
    ...
    public static double rightXOffset = 200;
    public static double iterOneOffY = 40;
    public static double rightYOffset = 0;
    public static double yOffsetGlobal = -60.0;

    private Pose2d backBoardCenter = new Pose2d(-1.0 * 36.0 * inToMm, 46.0 * inToMm + yOffsetGlobal);
    private Pose2d middlePos, rightPos, leftPos;


    public DriveToBackBoardBlueTruss(TeamPropPosition pos, int iter) {
        this.pos = pos;
