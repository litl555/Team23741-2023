...
public class DriveToSpikeStripF extends CommandBase {
    ...
    public static Pose2d endPos1 = new Pose2d(970, 300, -Math.toRadians(90));
    public static Pose2d endPos2 = new Pose2d(970, 300, -Math.toRadians(180));
    public static Pose2d endPos3 = new Pose2d(970, 300, -Math.toRadians(90));
    ...
    public void initialize() {
        ...
        Pose2d startPose = new Pose2d(Robot.l.getPoseEstimate().getY() * -1.0, Robot.l.getPoseEstimate().getX());
        switch (pos) {
            case right:
