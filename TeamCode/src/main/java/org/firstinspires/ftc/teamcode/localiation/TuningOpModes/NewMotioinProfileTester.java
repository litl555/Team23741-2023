...
public class NewMotioinProfileTester extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory trajectory = new Trajectory(new Pose2d(0, 0), new Pose2d(0, 1000), new Pose2d(3000, 4330), new Pose2d(10, 2745), new Pose2d(3110, 1950), new Pose2d(-1000, -600), true, true);
